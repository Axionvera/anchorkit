...
| Issue application guide                           | [`ISSUE_APPLICATION_GUIDE.md`](./docs/ISSUE_APPLICATION_GUIDE.md)               |
...
| Payment-period communication policy               | [`PAYMENT_PERIOD_COMMUNICATION_POLICY.md`](./docs/PAYMENT_PERIOD_COMMUNICATION_POLICY.md) |
...
| Reviewer evidence checklist                       | [`REVIEWER_EVIDENCE_CHECKLIST.md`](./docs/REVIEWER_EVIDENCE_CHECKLIST.md)       |
