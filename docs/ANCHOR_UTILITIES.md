...
1. Parsing and validation for deposit / withdrawal request metadata.
2. Typed anchor transaction statuses and user-facing message mapping.
3. Anchor asset and payment-rail configuration validators.
4. Callback URL validation.
5. Mock record factories and lifecycle fixtures for unit/integration tests.
