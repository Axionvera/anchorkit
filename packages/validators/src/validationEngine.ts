...
function toValidationErrors(code: AnchorValidationErrorCode, error: z.ZodError): ValidationError[] {
...
export function validateDepositRequest(input: unknown): ValidationResult<DepositRequestMetadata> {
...
export function validateAnchorAssetConfig(input: unknown): ValidationResult<AnchorAssetConfig> {
