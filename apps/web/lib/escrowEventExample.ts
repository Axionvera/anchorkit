// Typed fixture mirroring examples/escrow-events-example.json, used by the
// escrow page to demo the client-side event mapper.
import type { RawEscrowEvent } from '@anchorkit/types';

export const escrowEventExample: RawEscrowEvent[] = [
  {
    contractId: 'CCESCROWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAE',
